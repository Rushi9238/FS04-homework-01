function Main(){
    return <div style = {{width : "30%",height : "70%",marginTop : "3%",display : "flex",justifyContent : "center",flexDirection : "column",alignItems : "center",boxShadow : " inset 0 0 20px black",marginLeft : "30%",padding :"30px",borderRadius : "8px"}}>
    <div>
        <img src ="./profile.jpg"alt = "avatar" width = "100px" height = "100px"/>
    </div>
    <div style = {{display : "flex",justifyContent : "center",flexDirection : "column",alignItems : "center"}}>
        <h1 style = {{margin : "5px",padding : "5px"}}>Rushikesh Patil</h1>
